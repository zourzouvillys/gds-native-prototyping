 ...
 * {@link #write(Buffer, long) write}s from/to a buffer to an underlying
 * resource.
 *
 * @author smacke
 *
...
public interface BufferedChannel<T extends Buffer> extends Channel {
	...
	/**
	 * Writes from the <tt>src</tt> buffer into this channel at
	 * <tt>position</tt>.
	 * </p>
	 *
	 * @param src
	...
	/**
	 * Reads from this channel into the <tt>dst</tt> buffer from
	 * <tt>position</tt>.
	 * </p>
	 *
	 * @param dst
	...
	/**
	 * @return <tt>true</tt> if this channel is read only, <tt>false</tt>
	 *         otherwise
	 */
	 ...
	 *
	 * @param fileLength
	 *            The length to which to truncate
	 *
	...
	public BufferedChannel<T> allocate(int mode, long offset, long length) throws IOException;
	...
	public BufferedChannel<T> sync() throws IOException;
	...
	public BufferedChannel<T> sync(int offset, int len) throws IOException;
	...
	public BufferedChannel<T> seek(int offset, int whence) throws IOException;
	...
	public BufferedChannel<T> datasync() throws IOException;
